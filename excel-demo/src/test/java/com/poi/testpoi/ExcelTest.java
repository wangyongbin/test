...
import com.poi.model.DataAreaModel;
import com.poi.model.ExcelModel;
import com.poi.model.SheetModel;
...
public class ExcelTest {
    ...
    public String getTitle(Sheet sheet,TitleModel titleModel, List errors){
        ...
        if(r == null){
            //errors.add("数据异常，单元格坐标，纵坐标: "+rowIndex+"，横坐标："+cellIndex);
    ...
    public void setErrors(List errors,int i,int j){
        errors.add("数据异常，单元格坐标，纵坐标："+i+"，横坐标："+j);
    }
